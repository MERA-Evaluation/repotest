"""
TypeScript Docker repository test runner.
"""
...
def parse_typescript_test_output(stdout: str) -> Dict[str, object]:
...
class TypeScriptDockerRepo(AbstractDockerRepo):
    ...
    def _format_results(self, test_json: Optional[Dict] = None) -> Dict[str, object]:
        return {"stdout": self.stdout, "stderr": self.stderr, "std": self.std, "returncode": self.return_code,
                "parser": parse_typescript_test_output(self.stdout), "report": test_json or {},
