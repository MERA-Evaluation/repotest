...
from repotest.parsers.junit import parse_junit_report, parse_junit_stdout
...
class GoLangDockerRepo(PythonDockerRepo):
    ...
    def build_env(self,
        ...
        return super().build_env(command=command,
                                timeout=timeout,
    ...
    def run_test(self,
        ...
        return super().run_test(command=command,
                                timeout=timeout,
                                stop_container=stop_container
                                )
            # return
