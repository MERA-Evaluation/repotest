...
def test_python_docker_repo(repo_and_build_env):
    ...
    from repotest.core.docker.types import OutputBuildEnv
    ...
    from repotest.core.docker.types import OutputTests
    ...
    # ToDO: latency, now we are using strict typing
    from repotest.core.docker.types import OutputSummary
